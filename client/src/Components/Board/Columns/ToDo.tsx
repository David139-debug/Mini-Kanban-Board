...
const ToDo = ({ todoTasks, setOpenModal }: TodoProps) => {
      ...
      <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-4xl p-4">
          <div className="flex flex-col gap-3">
              <div className="flex gap-4 justify-between">
                  ...
                  <div onClick={() => setOpenModal(true)} className="flex justify-center items-center w-10 h-10 p-4 border border-[#CBD5E1] cursor-pointer rounded-full transition duration-100 hover:bg-[#e2ebf3]">
