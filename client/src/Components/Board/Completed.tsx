          ...
          <div className="flex flex-col gap-3">
              <div className="flex gap-4 justify-between">
                  <div className="flex gap-2 items-center">
                      ...
                      <h1 className="font-bold text-xl" style={{ fontFamily: "Plus Jakarta Sans" }}>Completed <span className="text-[#94A3B8]" style={{ fontFamily: "Plus Jakarta Sans" }}>({taskMap.length})</span></h1>
                  </div>
