...
const Edit = ({ dispatch, setEditModal, id }: ModalState) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{
            ...
            <div className="flex flex-col gap-8">
                <div className="flex justify-between">
                    ...
                    <svg onClick={() => setEditModal({ open: false, id: "" })} className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[#475569]">Please edit your task name</p>
                </div>
                ...
                <div className="flex gap-2 justify-end">
                    <button onClick={() => setEditModal({ open: false, id: "" })} className="cursor-pointer border rounded-full font-bold border-[#CBD5E1] py-2.5 px-4">Cancel</button>
