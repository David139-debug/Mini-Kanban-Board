          ...
          <div className="flex flex-col gap-3">
              <div className="flex gap-4 justify-between">
                  <div className="flex gap-2 items-center">
                      <strong className="w-2 h-2 rounded-full bg-[#F59E0B]"></strong>
                      <h1 className="font-bold text-xl" style={{ fontFamily: "Plus Jakarta Sans" }}>In Progress <span className="text-[#94A3B8]" style={{ fontFamily: "Plus Jakarta Sans" }}>({taskMap.length})</span></h1>
                  </div>
